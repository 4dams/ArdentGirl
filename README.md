...
The Riot API token can be retrieved [here](https://developer.riotgames.com/).</br>
Your Twitch OAuth token can be found [here](https://twitchapps.com/tmi/), once you logged in with the account you want to use the bot on.</br>
</br>
